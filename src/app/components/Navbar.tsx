...
function Navbar({}: Props) {
  return (
    <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-10 pb-5 flex items-center justify-between font-light text-zinc-300 sticky top-0 backdrop-blur-md z-20'>
        ...
        <motion.div initial={{opacity:0, y:100}} animate={{opacity:1, y:0}} transition={{duration:1, ease:'backOut'}}>
        ...
        <div className='max-md:hidden overflow-hidden'>
            <motion.div className='flex items-center space-x-6' initial={{opacity:0, y:-100}} animate={{opacity:1, y:0}} transition={{duration:2, ease:'backInOut'}} >
